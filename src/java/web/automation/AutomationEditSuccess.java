 ...
 * @author CK
 */
@WebServlet(name = "AutomationEditSuccess", urlPatterns = {"/automation/AutomationEditSuccess"})
public class AutomationEditSuccess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!userPlants.isEmpty()) {
                ...
                upm.setErrors(true);
                upm.setStatus("Du hast noch keine Pflanzen angelegt :-)");
            }

            RequestDispatcher rd
                    = request.getRequestDispatcher("/automation/AutomationEditSuccess.jsp");

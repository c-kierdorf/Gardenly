<%-- 
    Document   : PlantEditSuccess
    Created on : 14.03.2022, 17:50:57
    Author     : CK
--%>
...
<html lang="de">
    <head>
        ...
        <title>Gardenly Pflanze erfolgreich geändert</title>
    </head>
            ...
            <div class="items-center py-6">
                <c:choose>
                    <c:when test="${!pm.errors}">
                        <h2 class="text-3xl pt-2 text-main-green font-Metropolis font-bold">${pm.plant.name} erfolgreich bearbeitet</h2>

...
<html lang="de">
    <head>
        ...
        <title>Gardenly Pflanze zum Wiki hinzufügen</title>
    </head>
    <body class="antialiased h-screen body-bg font-Metropolis">
        ...
        <div class="container px-4 mx-auto">
            ...
            <div class="items-center py-6">
                <h2 class="h-10 text-3xl pt-2 text-main-green font-Metropolis font-bold">Neue Pflanze zur Datenbank hinzufügen</h2>
            </div>
        </div>
                ...
                <div class="justify-center">
                    ...
                    <div class="flex flex-row flex-wrap w-full gap-3 items-start items-center border-b-2 border-gray-300">
                        ...
                        <div class="flex flex-row flex-wrap w-full gap-3 items-start items-center border-b-2 border-gray-300">
                            ...
                            <!-- cell left-->
                            <div class="flex-none w-24 p-4 bg-white">
                                <p class="text-xs font-semibold text-gray-500 p-input-labels">Standort</p>
                            </div>

...
<html lang="de">
    <head>
        ...
        <title>Gardenly Pflanze erfolgreich hinzufügt</title>
    </head>
            ...
            <div class="items-center py-6">
                <c:choose>
                    <c:when test="${!pm.errors}">
                        <h2 class="text-3xl pt-2 text-main-green font-Metropolis font-bold">${pm.plant.name} erfolgreich gespeichert</h2>

                        <section  class="text-center px-4 mx-auto w-full mt-12">
                            <a href="/Gardenly/plants/PlantAdd.jsp" id="login" class="register">

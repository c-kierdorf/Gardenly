<%-- 
    Document   : UserPlantWaterNowSuccess
    Created on : 10.06.2022, 17:22:13
    Author     : CK
--%>
...
<html lang="de">
    <head>
        ...
        <title>Gardenly Bewässerungsauftrag gesendet</title>
    </head>
            ...
            <div class="items-center py-6">
                <c:choose>
                    <c:when test="${!upm.errors}">
                        <h2 class="text-3xl pt-2 text-main-green font-Metropolis font-bold">Bewässerungsauftrag erfolgreich gesendet</h2>
                        <p class="text-base font-medium text-gray-500 py-6">
                            Die Bewässerungsanweisung für ${upm.userPlant.userPlantName} wurde erfolgreich an das Gardenly-Modul gesendet. 
                            Die Bewässerung startet in wenigen Augenblicken. Prüfe die Bodenfeuchtigkeit anschließend erneut.
                        </p>

                        <section  class="text-center px-4 mx-auto w-full mt-12">
                            <a href="/UserPlantDetails?up_id=${upm.userPlant.userPlantsId}" 
                                ...
                                <div class="bg-main-green-500 hover:bg-main-green-600 active:transform active:scale-90 transition-all text-white font-semibold w-full py-4 px-4 rounded-xl mb-3">
                                    Zurück zu ${upm.userPlant.userPlantName}
                                </div>
                            </a>

...
<html lang="de">
    <head>
        ...
        <title>Gardenly Meine Pflanze erfolgreich bearbeitet</title>
    </head>
            ...
            <div class="items-center py-6">
                <c:choose>
                    <c:when test="${!upm.errors}">
                        <h2 class="text-3xl pt-2 text-main-green font-Metropolis font-bold">${upm.userPlant.userPlantName} erfolgreich bearbeitet</h2>

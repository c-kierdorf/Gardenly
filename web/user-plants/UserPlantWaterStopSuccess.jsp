<%-- 
    Document   : UserPlantWaterStopSuccess
    Created on : 10.06.2022, 22:34:07
    Author     : CK
--%>
...
<html lang="de">
    <head>
        ...
        <title>Gardenly Bewässerungsauftrag abgebrochen</title>
    </head>
            ...
            <div class="items-center py-6">
                <c:choose>
                    <c:when test="${!upm.errors}">
                        <h2 class="text-3xl pt-2 text-red-500 font-Metropolis font-bold">Bewässerungsauftrag erfolgreich abgebrochen</h2>
                        <p class="text-base font-medium text-gray-500 py-6">
                            Die Bewässerungsanweisung für ${upm.userPlant.userPlantName} wurde erfolgreich abgebrochen und wird nicht mehr an das Gardenly-Modul gesendet. 
                        </p>
